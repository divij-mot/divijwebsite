    ...
    <div className="relative min-h-screen overflow-hidden" style={{ fontFamily: 'Georgia, serif' }}>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 pt-32 pb-64">
        <h1 
          ...
          className={`text-4xl md:text-5xl font-bold mb-4 cursor-pointer transition-colors duration-300 ${
        ...
        <p className={`text-base md:text-lg mb-2 transition-colors duration-300 ${
